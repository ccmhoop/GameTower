...
public class BackgroundManager extends BackGroundEntity {
    ...
    public static BufferedImage[] background= new BufferedImage[21];
    CloudAni cloudAni;
        ...
        try {
          ...
          // background[4] = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/res/background/m7/2.png")));
           // background[5]= ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/res/background/m1/4.png")));
            ...
            background[15] = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/res/background/Mountain_BG_04/Layers/Mount_BG.png")));
            background[16]= ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/res/background/Mountain_BG_04/Layers/Decor_01.png")));
            background[17]= ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/res/background/Mountain_BG_04/Layers/Decor_02.png")));
            background[18] = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/res/background/m3/5.png")));
            background[19] = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/res/background/Mountain_BG_04/Layers/Ground.png")));
            background[20] = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("")));
        }catch(IOException e){
            e.printStackTrace();
            }
        for (int i=0;i<=10;i++){
